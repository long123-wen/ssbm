...
import { toDatetimeLocalValue } from '@/lib/deadline';
...
export default function CompetitionSelector({ onSelect, onLogout }: Props) {
  ...
  const openEdit = (comp: Competition) => {
    ...
    setForm({
      ...
      registrationDeadline: toDatetimeLocalValue(comp.registrationDeadline),
      ...
      <Dialog open={showModal} onOpenChange={setShowModal}>
        <DialogContent className="max-w-md max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-1">报名截止时间</label>
              <input
                type="datetime-local"
